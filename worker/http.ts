 ...
 *
 * Está aparte del enrutador porque las dos mitades —el historial y los
 * clientes— tienen que rechazar igual: la pantalla decide qué ofrecer mirando
 * el `codigo` y no le importa cuál de los dos módulos lo emitió.
 */
...
export function json(datos: unknown, estado = 200): Response {
  return new Response(JSON.stringify(datos), {
    ...
    headers: {
      ...
      // Lo que hay aquí dentro son los clientes de la empresa: que no lo
      // guarde ninguna caché intermedia ni quede en el disco de nadie.
