// El símbolo de PanaClaw para el <canvas> de exportación.
// Mismo trazado que assets/logo-original.svg y que datos/marca.json → logo.pathSVG.
// Se copia, no se redibuja: descrito en prosa, un modelo devuelve trazos con
// stroke que no son esta marca.
...
// Colocación en una pieza de 1080 de ancho: 88 × 72, centrado, borde superior
// en y=96. La escala va IGUAL en los dos ejes — el símbolo no es cuadrado.
function dibujarSimboloPanaClaw(ctx, anchoLienzo) {
  ctx.save();
